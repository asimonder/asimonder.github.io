<body style="display: flex; height: 100vh; background-color: #f0f0f0; margin: 0; font-family: Arial, sans-serif;">
    <div class="profile-container" style="text-align: left;">
        <div class="name-container" >
            ...
            <p>Ph.D. Student</p>
            <p><i>Fully-coupled modelling and analysis of turbulent air-sea exchange  </i> </p> 
        </div>
    </div>
    <div class="social-icons" style="margin-top: 20px;">
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=jose.belmar784@gmail.com" style="text-decoration: none; color: inherit; margin: 0 10px;">
                <i class="fas fa-envelope" style="font-size: 24px; color: #0077b5;"></i>
            </a>
